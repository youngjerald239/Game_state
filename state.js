...
export class FallingLeft extends State {
    ...
    handleInput(input){
        if (input === 'PRESS right') this.player.setState(states.FALLING_RIGHT) // set state to StandingRight 
        else if(this.player.onGround()) this.player.setState(states.STANDING_LEFT)
    }
}
export class FallingRight extends State {
    ...
    handleInput(input){
        if (input === 'PRESS left') this.player.setState(states.FALLING_LEFT) // IGHTset state to StandingRight 
        else if(this.player.onGround()) this.player.setState(states.STANDING_RIGHT)
    }
}